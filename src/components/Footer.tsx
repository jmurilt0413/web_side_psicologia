import { CONTACT, LEGAL, NAV_LINKS } from "../data/content";
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-sm text-white/60 hover:text-white transition-colors no-underline flex items-center gap-2"
                >
          ...
          <div>
            ...
            <div className="bg-white/10 rounded-xl p-4">
              ...
              >
                ...
                Línea de crisis: {LEGAL.crisisLine}
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-white/40">
            &copy; {currentYear} Mónica Toro Muñetón. Todos los derechos reservados.
          </p>
          <p className="text-xs text-white/40">
            {LEGAL.privacyNote}
          </p>
